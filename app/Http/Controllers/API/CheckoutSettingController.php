    ...
    public function update(Request $request, string $storeId)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'order_bump_bg_color' => 'nullable|string|max:20',
                'order_bump_border_color' => 'nullable|string|max:20',
                'order_bump_button_color' => 'nullable|string|max:20',
                'order_bump_button_text_color' => 'nullable|string|max:20',
                'upsell_bg_color' => 'nullable|string|max:20',
                'upsell_border_color' => 'nullable|string|max:20',
                'upsell_text_color' => 'nullable|string|max:20',
                'upsell_button_color' => 'nullable|string|max:20',
                'upsell_button_text_color' => 'nullable|string|max:20',
                'downsell_bg_color' => 'nullable|string|max:20',
                'downsell_border_color' => 'nullable|string|max:20',
                'downsell_text_color' => 'nullable|string|max:20',
                'downsell_button_color' => 'nullable|string|max:20',
                'downsell_button_text_color' => 'nullable|string|max:20',
                'gift_bg_color' => 'nullable|string|max:20',
                'gift_border_color' => 'nullable|string|max:20',
                'gift_badge_bg_color' => 'nullable|string|max:20',
                'gift_badge_border_color' => 'nullable|string|max:20',
                'gift_badge_text_color' => 'nullable|string|max:20',
                'gift_progress_color' => 'nullable|string|max:20',
                'gift_progress_bg_color' => 'nullable|string|max:20',
                'dark_mode' => 'boolean',
